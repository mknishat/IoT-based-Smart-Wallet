...
1. **Sensors:** TCS3200 (RGB), two HC-SR04 (distance)  
2. **MCU:** **Arduino Mega 2560** (sensor fusion, JSON build)  
3. **Connectivity:** **ESP-12E (ESP8266)** for Wi-Fi and HTTP POST  
4. **UI:** 16×2 I²C LCD (PCF8574)  
5. **Cloud/App:** Google Sheets (via Apps Script endpoint) + mobile app dashboard
